...
namespace CustomerManagement.Application.Commands.AddCustomer
{
    public class CreateCustomerCommandHandler : IRequestHandler<CreateCustomerCommand, Guid>
    {
        ...
        {
            var customer = new Customer(Guid.NewGuid(), request.Name, request.PhoneNumber, request.BusinessPhone, request.HomePhone, request.CNPJ, request.CPF, request.RG, request.CEP,
