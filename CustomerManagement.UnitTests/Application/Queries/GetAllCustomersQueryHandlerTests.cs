...
namespace CustomerManagement.UnitTests.Application.Queries
{
    public class GetAllCustomersQueryHandlerTests
    {
        ...
        public async Task ThreeCustomersExists_Executed_ReturnThreeCustomersCustomerViewModel()
        {
            ...
            {
                new Customer(Guid.NewGuid(), "John Doe", "123456789", "22222222222", "333333333", "44444444", "1231231231", "Street 1", 1, "Additional 1", "john.doe@example.com", "www.example.com", "Description 1", "url1.jpg", Guid.NewGuid(), Guid.NewGuid()),
                new Customer(Guid.NewGuid(), "Jane Smith", "987654321", "66666666666", "777777777", "88888888", "1231231231", "Street 2", 2, "Additional 2", "jane.smith@example.com", "www.example.com", "Description 2", "url2.jpg", Guid.NewGuid(), Guid.NewGuid()),
                new Customer(Guid.NewGuid(), "Bob Johnson", "555555555", "88888888888", "777777777", "66666666", "12312312312", "Street 3", 3, "Additional 3", "bob.johnson@example.com", "www.example.com", "Description 3", "url3.jpg", Guid.NewGuid(), Guid.NewGuid())
            };
        ...
        {
            // Arrange
            Customer customer = new(Guid.NewGuid(), "John Doe", "123456789", "22222222222", "333333333", "44444444", "1231231231", "Street 1", 1, "Additional 1", "john.doe@example.com", "www.example.com", "Description 1", "url1.jpg", Guid.NewGuid(), Guid.NewGuid());
